...
import { Gamepad2, Trophy, Users, Calendar, Menu } from "lucide-react"
                ...
                <NavigationMenuContent>
                  <div className="grid gap-3 p-6 md:w-[400px] lg:w-[500px]">
                    <NavigationMenuLink asChild>
                      ...
                      >
                        <div className="text-sm font-medium leading-none">All Tournaments</div>
                    ...
                    <NavigationMenuLink asChild>
                      <Link
                        ...
                        className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                      >
                        <div className="text-sm font-medium leading-none">PUBG Tournaments</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                    ...
                    <NavigationMenuLink asChild>
                      <Link
                        ...
                        className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                      >
                        <div className="text-sm font-medium leading-none">Free Fire Tournaments</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                          Fast-paced mobile battles
                        </p>
                      </Link>
                    </NavigationMenuLink>
                  </div>
